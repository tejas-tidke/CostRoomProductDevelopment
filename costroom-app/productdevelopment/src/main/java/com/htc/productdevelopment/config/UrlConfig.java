...
public class UrlConfig {
		           ...
		           public static final String LOCALHOST = "http://localhost:5173";
			           public static final String LOCALHOST_IP = "http://127.0.0.1:5173";
				           public static final String NETWORK_IP = "http://192.168.1.115:5173";
					           public static final String PRODUCTION = "http://192.168.1.115"; // Production server IP (serving frontend on port 80)
														           public static final String PRODUCTION_API = "http://192.168.1.115:8080"; // Production server IP with API port
     ...
     */
    @Value("${app.frontend.url:http://192.168.1.115}")
    private String frontendUrl;

    @Value("${app.frontend.ip.url:http://192.168.1.115}")
