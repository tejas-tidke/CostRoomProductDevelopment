...
export const API_BASE_URLS = {
  // Production URLs (relative paths for NGINX reverse proxy)
  PRODUCTION: '',
  
  // Default fallback (relative paths)
  DEFAULT: ''
};
...
export const FRONTEND_URLS = {
  ...
  // Production URLs
  PRODUCTION: 'http://192.168.1.115', // Server IP without port for production
...
export function getApiBaseUrl(): string {
  ...
  // Use relative paths for production with NGINX reverse proxy
  // In production, API calls will be proxied by NGINX
